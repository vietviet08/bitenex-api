...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_dispatch_assignments_driver_id'), 'dispatch_assignments', ['driver_id'], unique=False)
    op.create_index(op.f('ix_dispatch_assignments_order_id'), 'dispatch_assignments', ['order_id'], unique=False)
    op.create_table('dispatch_configs',
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_dispatch_assignments_order_id'), table_name='dispatch_assignments')
    op.drop_index(op.f('ix_dispatch_assignments_driver_id'), table_name='dispatch_assignments')
